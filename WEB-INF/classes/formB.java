...
public class formB extends HttpServlet {
      ...
      throws ServletException, IOException
   {
	...
	if (firstname.equals("") || lastname.equals("")){
		...
		output.println( "<BODY  text='white'  background='./images/backgroundIntro.png'></HEAD><h3 class='header' text-align='center'>You must provide a name before continuing!</h3><br><div align='center'>" );
		...
		output.println("<img style=' width: auto; height: auto' src='./images/givemename.png'>");
	}
	else{
...
// BY
 ...
 //
	  ...
	  output.println( "font-style:    italic; color: red;background-color : black; text-align: center;" );
	  output.println( "}.form-radio-item label, .form-checkbox-item label {white-space: normal; display: block; left: 14px; top: -14px; position relative; } </style>" );
	  output.println( "<BODY background='./images/backgroundIntro.png'></HEAD><h1 class='header' text-align='center'>Give us info about your order</h1><br><div align='center'>" );
	  ...
	  if(category.equals("console")){
		  ...
		  output.println( "<label><img style=' width: 200px; height: 150px' src='./images/ps3.jpg'><input type='checkbox' name='Playstation3' value='Playstation3'><font color='white'>Playstation 3 </font></label><br>");
		  output.println( "<label><img style=' width: 200px; height: 150px' src='./images/playstation4.jpg'><input type='checkbox' name='Playstation4' value='Playstation4'><font color='white'> Playstation 4</font></label> <br>");
		  output.println( "<label><img style=' width: 200px; height: 150px' src='./images/xboxone.png'><input type='checkbox' name='XboxOne' value='XboxOne'><font color='white'> Xbox One </font></label><br>");
		  output.println( "<label><img style=' width: 200px; height: 150px' src='./images/xbox360.jpg'><input type='checkbox' name='Xbox360' value='Xbox360'><font color='white'> Xbox 360 </font></label><br>");
		  output.println( "<label><img style=' width: 200px; height: 150px' src='./images/wii.jpg'><input type='checkbox' name='Wii' value='Wii'><font color='white'> Wii </font><br>");

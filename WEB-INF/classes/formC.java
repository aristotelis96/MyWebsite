...
public class formC extends HttpServlet {
      ...
      throws ServletException, IOException
   {
	  ...
	  output.println( "<BODY  text='white' background='./images/backgroundIntro.png'></HEAD><h1 class='header' text-align='center'>Final step! Check your form before submit!</h1><br><div align='center'>" );
